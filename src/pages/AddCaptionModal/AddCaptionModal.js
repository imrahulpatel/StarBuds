...
class AddCaptionModal extends Component {
    ...
    headerLeft: (
      ...
      >
        ...
        <Image
          ...
          style={[Styles.headerLeftImage, { height: 15, width: 8 , tintColor : 'black'}]}
        />
      </TouchableOpacity>
    ),
    headerRight: (
  ...
  renderSuggestionsLoadingComponent = () => {
    return (
      <View style={{ flex: 1, width: Metrics.screenWidth, justifyContent: 'center', alignItems: 'center', backgroundColor: 'white' }}>
        <ActivityIndicator
          animating
          size='small'
          style={{padding: 15}}
