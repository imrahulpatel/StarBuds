...
class NewPost extends Component {
  ...
  componentWillMount() {
    ...
    DeviceEventEmitter.addListener("tagpeopleUpdated", e => {
      this.setState({ 
        updatetaggedpeople:e
      });
    });
      ...
      <View style={NewPostStyle.tagPeopleConatiner}>
        ...
        <View style={NewPostStyle.iconContainer}>
          ...
          <Image
            ...
            style={this.props.taggedPeople.length > 0?NewPostStyle.tagIconSelectedStyle:NewPostStyle.tagIconStyle}
          />
        ...
        <View style={NewPostStyle.textContainer}>
          ...
          <TouchableOpacity onPress={() => this.goToTagPeople()}>
            ...
            <Text style={NewPostStyle.listText}>{(this.props.taggedPeople.length > 0 && this.state.updatetaggedpeople) ?

               
               this.fetchtagpeoplename()
  ...
  fetchtagpeoplename(){
    ...
    this.props.taggedPeople.map((data,index) => {
      if(index!=0){
  ...
  renderAddLocation() {
    ...
    if (this.selectedLocation.description == "") {
      locationIconSource = Images.mapPin_Selected;
    } else {
      locationIconSource = Images.mapPin_Selected;
    }
      ...
      >
        <View style={NewPostStyle.iconContainer}>
          <Image
            ...
            style={this.selectedLocation.description == ""?NewPostStyle.locationIconStyle:NewPostStyle.locationIconSelectedStyle}
          />
        </View>
        <View style={NewPostStyle.textContainer}>
    ...
    return (
      <View style={NewPostStyle.locationsContainer}>
        {this.state.nearByLocations.length > 0 && !this.props.loading ? (
          ...
          >
            <Text style={{ color: Colors.dark, marginLeft: 20 }}>
    ...
    return (
      <View style={NewPostStyle.turnOffCommentingContainer}>
        <View style={NewPostStyle.iconContainer}>
          ...
          /> */}
      <ToggleSwitch
        isOn={this.state.isToogleOn}
        onColor='rgb(110,206,26)'
        offColor='rgb(157,164,179)'
        size='medium'
        onToggle={ (isOn) => 
          this.setState({ isToogleOn: isOn }) 
        }
      />   
        </View>
        <View style={NewPostStyle.textContainer}>
